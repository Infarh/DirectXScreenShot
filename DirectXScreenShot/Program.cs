...
static Bitmap TakeScreenshot()
{
    ...
    using var duplicated_output = output1.DuplicateOutput(device);
    ...
    try
    {
        ...
        using (Texture2D screenTexture2D = screen_resource.QueryInterface<Texture2D>())
            device.ImmediateContext.CopyResource(screenTexture2D, screen_texture);
